...
4. `recordLessonWatchProgress` separa retomada, posição máxima, fronteira linear e tempo de reprodução; somente a fronteira validada pode concluir por vídeo em 98%.
